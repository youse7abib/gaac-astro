...
// Session-scoped persistence: the mock/exam opens from the team dashboard in
// the same tab, so this session survives that navigation but never silently
// auto-logins a stale session on a fresh visit.
